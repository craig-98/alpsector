...
import { UserPlus, Mail, ShieldCheck, DollarSign, BarChart3, ArrowLeftRight } from "lucide-react"
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center group-hover:text-emerald-600 transition">{step.title}</h3>
